...
public class TermUpdate {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("pos")
    private Optional<? extends TermUpdatePos> pos;
    ...
    public TermUpdate(
            ...
            @JsonProperty("pos") Optional<? extends TermUpdatePos> pos,
            @JsonProperty("tags") Optional<? extends java.util.List<TermTagCreate>> tags,
            @JsonProperty("term") String term,
            @JsonProperty("type") TermUpdateType type) {
    ...
    public TermUpdate(
            ...
            String term,
            TermUpdateType type) {
        this(Optional.empty(), caseSensitive, Optional.empty(), Optional.empty(), Optional.empty(), id, Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), term, type);
    }
    ...
    @JsonIgnore
    public Optional<? extends TermUpdatePos> pos() {
        return pos;
    }
    ...
    public TermUpdate withApprovedTermExtension(Optional<? extends ApprovedTermExtensionCreate> approvedTermExtension) {
        Utils.checkNotNull(approvedTermExtension, "approvedTermExtension");
        this.approvedTermExtension = approvedTermExtension;
        return this;
    }
    ...
    public TermUpdate withDescription(Optional<? extends String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }

    public TermUpdate withExamples(java.util.List<TermExampleCreate> examples) {
        Utils.checkNotNull(examples, "examples");
        this.examples = Optional.ofNullable(examples);
        return this;
    }

    public TermUpdate withExamples(Optional<? extends java.util.List<TermExampleCreate>> examples) {
        Utils.checkNotNull(examples, "examples");
        this.examples = examples;
        return this;
    }
    ...
    public TermUpdate withHighlight(Optional<? extends Boolean> highlight) {
        Utils.checkNotNull(highlight, "highlight");
        this.highlight = highlight;
        return this;
    }
    ...
    public TermUpdate withLinkedTerms(java.util.List<LinkedTermCreate> linkedTerms) {
        Utils.checkNotNull(linkedTerms, "linkedTerms");
        this.linkedTerms = Optional.ofNullable(linkedTerms);
        return this;
    }

    public TermUpdate withLinkedTerms(Optional<? extends java.util.List<LinkedTermCreate>> linkedTerms) {
        Utils.checkNotNull(linkedTerms, "linkedTerms");
        this.linkedTerms = linkedTerms;
        return this;
    }

    public TermUpdate withMistakes(java.util.List<TermMistakeCreate> mistakes) {
        Utils.checkNotNull(mistakes, "mistakes");
        this.mistakes = Optional.ofNullable(mistakes);
        return this;
    }

    public TermUpdate withMistakes(Optional<? extends java.util.List<TermMistakeCreate>> mistakes) {
        Utils.checkNotNull(mistakes, "mistakes");
        this.mistakes = mistakes;
        return this;
    }
    ...
    public TermUpdate withPos(Optional<? extends TermUpdatePos> pos) {
        Utils.checkNotNull(pos, "pos");
        this.pos = pos;
        return this;
    }

    public TermUpdate withTags(java.util.List<TermTagCreate> tags) {
        Utils.checkNotNull(tags, "tags");
        this.tags = Optional.ofNullable(tags);
        return this;
    }

    public TermUpdate withTags(Optional<? extends java.util.List<TermTagCreate>> tags) {
        Utils.checkNotNull(tags, "tags");
        this.tags = tags;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(TermUpdate.class,
    ...
    public final static class Builder {
        ...
        private Optional<? extends TermUpdatePos> pos = Optional.empty();
        ...
        public Builder pos(TermUpdatePos pos) {
            Utils.checkNotNull(pos, "pos");
            this.pos = Optional.ofNullable(pos);
            return this;
        }

        public Builder pos(Optional<? extends TermUpdatePos> pos) {
            Utils.checkNotNull(pos, "pos");
            this.pos = pos;
            return this;
        }
        ...
        public Builder type(TermUpdateType type) {
            Utils.checkNotNull(type, "type");
            this.type = type;
            return this;
        }
